        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "VideoObject",
              "name": "Flyreel - Professional Drone Cinematography Showreel",
              "description": "Professional drone cinematography and FPV footage showcasing our aerial video production capabilities",
              "thumbnailUrl": "https://www.flyreel.art/flyreel-thumbnail.jpg",
              "uploadDate": new Date().toISOString(),
              "contentUrl": "https://www.flyreel.art/flyreel_one_compressed.mp4",
              "embedUrl": "https://www.flyreel.art",
              "duration": "PT2M30S",
              "publisher": {
                "@type": "Organization",
                "name": "Flyreel",
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://www.flyreel.art/flyreel-logo.png"
                }
              }
            })
          }}
      ...
      <main className="relative min-h-screen w-full overflow-x-hidden font-sans">
        ...
        <header className="fixed top-0 left-0 w-full z-30 flex items-center justify-between px-8 py-4 bg-black/40 backdrop-blur-md shadow-lg">
          <div className="flex items-center gap-3">
            ...
            <h1 className="ml-2 text-2xl font-extrabold tracking-widest text-white select-none" style={{letterSpacing: '0.15em'}}>FLYREEL</h1>
          </div>
          <nav className="flex gap-8" role="navigation" aria-label="Main navigation">
            <button className="text-white text-lg font-semibold hover:text-blue-300 transition" onClick={() => handleScroll('about')} aria-label="Navigate to About section">About</button>
            <button className="text-white text-lg font-semibold hover:text-blue-300 transition" onClick={() => handleScroll('contact')} aria-label="Navigate to Contact section">Contact</button>
          </nav>
        </header>
        
        {/* Hero Video Section */}
        <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden pt-0 pb-0" style={{minHeight: '100vh'}} aria-label="Hero section with drone cinematography showcase">
          <video
            ...
            muted
            playsInline
            aria-label="Flyreel drone cinematography showcase video"
          />
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center z-10 animate-fadein">
            <Image 
              ...
              alt="Flyreel - Professional Drone Cinematography Logo" 
              width={400} 
              height={400} 
              priority 
              style={{
            ...
            />
            <p style={{fontFamily: 'Montserrat, Nunito Sans, Work Sans, Arial, sans-serif'}} className="mt-6 text-2xl md:text-3xl font-light text-white tracking-wide text-center block">
            ...
            <button
              ...
              aria-label="Play Flyreel showcase video"
            >
              Play Flyreel
            </button>
          </div>
          ...
          <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 flex justify-center">
              <div className="relative w-full max-w-lg h-[400px] lg:h-[500px] overflow-hidden">
                <Image 
                  src="/drone-image.jpg" 
                  alt="Professional drone cinematography equipment and aerial filming setup" 
                  fill
                  style={{
                    objectFit: 'cover',
            ...
            <div className="w-full lg:w-1/2">
              <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                ...
                <br /><br />
                <strong className="font-semibold text-gray-800">We elevate your vision through our network of skilled professionals</strong> – including filmmakers, producers, sound designers, social media managers, and web designers – we support your project from concept to final cut. We focus on every detail to ensure your story is told with clarity and cinematic quality.
              </p>
